...
fn main() {
    ...
    #[cfg(feature = "out_pb")] {
        #[cfg(feature = "mod_bitbay")] {
            ...
            println!("cargo:rerun-if-changed=src/bitbay/trading_candle/pb/trading_candle.proto");
            protobuf_codegen_pure::Codegen::new()
                .input("src/bitbay/trading_candle/pb/trading_candle.proto")
                .include("src/bitbay/trading_candle/pb")
                .out_dir("src/bitbay/trading_candle/pb")
                .run()
                .expect("Codegen failed.");
        }
    }
