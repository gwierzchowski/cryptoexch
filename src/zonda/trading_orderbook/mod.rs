/*!
 * Implementation of "trading/orderbook" API from "Zonda" module.
 * 
 * This module is able to download data in JSON format from _https://api.Zonda.net/rest/trading/orderbook and save in file in several output formats.
 */
