/*!
 * Implementation of "trading/ticker" API from "Zonda" module.
 * 
 * This module is able to download data in JSON format from _https://api.zonda.exchange/rest/trading/ticker_ and save in file in several output formats.
 */
...
// #[cfg_attr(feature = "out_hdf", derive(hdf5::H5Type))]
// #[repr(C)]
struct TickOut {
    time: u64,
    lowestAsk: Option<f32>,
