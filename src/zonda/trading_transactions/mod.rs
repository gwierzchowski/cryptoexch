/*!
 * Implementation of "trading/transactions" API from "Zonda" module.
 * 
 * This module is able to download data in JSON format from _https://api.zonda.exchange/rest/trading/transactions and save in file in several output formats.
 */
